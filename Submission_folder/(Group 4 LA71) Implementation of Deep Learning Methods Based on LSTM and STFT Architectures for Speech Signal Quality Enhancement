...
* Source Code (Notebooks): https://github.com/GabrielRubenWeslie/lstm-stft-speech-enhancement/tree/main/src
* Documentation (Paper, Poster, PPT, and Video): https://github.com/GabrielRubenWeslie/lstm-stft-speech-enhancement/tree/main/docs

### 6. Link of PPT File
Direct link to the presentation slides:
* Presentation Slides: https://github.com/GabrielRubenWeslie/lstm-stft-speech-enhancement/blob/main/docs/PPT%20UAS%20Machine%20Learning.pdf
